...
{/* قسم خريطة اليمن الكاملة */}
<section className="my-12 px-4 max-w-7xl mx-auto">
  <h2 className="text-2xl font-bold mb-6 text-center text-gray-800">موقعنا في اليمن</h2>
  <div className="w-full h-[500px] rounded-2xl overflow-hidden shadow-2xl border-4 border-white">
    <iframe
      src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3844614.5428453474!2d43.61483328515626!3d15.3694451!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x1603db04e626801b%3A0x647e335501869f0e!2z2KfZhNmK2YXZhg!5e0!3m2!1sar!2s!4v1711654400000!5m2!1sar!2s"
      width="100%"
      height="100%"
      style={{ border: 0 }}
  ...
  <p className="mt-4 text-center text-gray-600 font-medium">
    نحن نخدم جميع محافظات الجمهورية اليمنية 🇾🇪
  </p>
</section>
